"use client";
// MFT-lab Create Strategy "Results" tab — Figma node 13964:56918, matching the xno-builder
// reference (`KetQuaStrategy.tsx` + `TongQuanComponent.tsx`) against the XALPHA API.
// Swapped in from results-tab.tsx via `variant="mft"`. The six-screen Figma 15204 UI is HFT
// Create Strategy Results and is shown for MFT-type *runs* (bar data), not for this lab.
...
export function XalphaMftResultsView({ strategyId }: { strategyId?: string }) {
