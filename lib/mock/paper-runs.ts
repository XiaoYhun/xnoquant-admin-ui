...
export const MOCK_PAPER_RUNS: PaperRunBase[] = [
  ...
  { id: "HFT-LqJvB9C", owner_id: "user-someone-else", strategyName: "Reversal Hunter", strategyType: "HFT", status: "paused", accounts: ["DN-002"], symbols: [{ symbol: "BTCUSD", market: "Crypto" }], timeframe: "5min", strategyId: strategyIdFor(3), symbolIds: symbolIdsFor(3, 1), executionType: "taker", returnPct: 56.13, sharpe: 1.6, maxDrawdownPct: -7.34, pnlSeries: pnlSeries(3, 0.8), pnlChartSeries: pnlChartSeries(3, 0.8), returnsChartSeries: returnsChartSeries(3) },
